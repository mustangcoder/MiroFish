...
class ZepEntityReader:
    ...
    def get_all_nodes(self, graph_id: str) -> List[Dict[str, Any]]:
        ...
        nodes = self.client.get_all_nodes(graph_id) if getattr(self, '_backend', 'cloud') == 'graphiti' else fetch_all_nodes(self.client, graph_id)
    ...
    def get_all_edges(self, graph_id: str) -> List[Dict[str, Any]]:
        ...
        edges = self.client.get_all_edges(graph_id) if getattr(self, '_backend', 'cloud') == 'graphiti' else fetch_all_edges(self.client, graph_id)
        ...
        *,
        ...
        try:
            ...
            edges = self._call_with_retry(
                func=(lambda: self.client.get_node_edges(node_uuid)) if getattr(self, '_backend', 'cloud') == 'graphiti' else (lambda: self.client.graph.node.get_edges(node_uuid=node_uuid)),
    ...
    def get_entity_with_context(
        ...
        try:
            ...
            node = self._call_with_retry(
                func=(lambda: self.client.get_node(entity_uuid)) if getattr(self, '_backend', 'cloud') == 'graphiti' else (lambda: self.client.graph.node.get(uuid_=entity_uuid)),
